...
var factory = module.exports = function (request) {
    console.log("🚀 ~ file: collections.js:9 ~ request", request)
    ...
    var InnerCollection = function (parentCollection, id, collection, options) {
        console.log("🚀 ~ file: collections.js:17 ~ InnerCollection ~ options", JSON.stringify(options, null, 2))
        this.get = function (callback) {
            const path = getPath(parentCollection, id, collection);
            console.log('InnerCollection.get Path:', path);
            ...
            request({
                ...
                console.log('InnerCollection.get Request Result:', err, result);
                callback(err, result && (result.resources || result));
            });
        };

        this.post = function (innerId, callback) {
            const path = getPath(parentCollection, id, collection, innerId)
            console.log('InnerCollection.post Path:', path);
            ...
            request({
                ...
                console.log('InnerCollection.post Request Result:', err, result);
                callback(err, result && (result.resources || result));
            });
        };
        ...
        this.put = function (innerId, callback) {
            const path = getPath(parentCollection, id, collection, innerId)
            console.log('InnerCollection.put Path:', path);
            ...
            request({
                ...
                console.log('InnerCollection.put Request Result:', err, result);
                callback(err, result && (result.resources || result));
            });
        };
        ...
        this.patch = function (innerId, callback) {
            const path = getPath(parentCollection, id, collection, innerId)
            console.log('InnerCollection.patch Path:', path);
            ...
            request({
                ...
                console.log('InnerCollection.patch Request Result:', err, result);
                callback(err, result && (result.resources || result));
            });
        };
        ...
        this.delete = function (innerId, callback) {
            const path = getPath(parentCollection, id, collection, innerId)
            console.log('InnerCollection.delete Path:', path);
            ...
            request({
                ...
                console.log('InnerCollection.delete Request Result:', err, result);
                callback(err, result && (result.resources || result));
            });
        };
    };
    ...
    this.create = function (collection, schema, innerCollections, options) {
        console.log('Factory.create:', collection, schema, innerCollections, options);
